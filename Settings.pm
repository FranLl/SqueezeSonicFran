package Plugins::SqueezeSonicFran::Settings;
...
my $log = Slim::Utils::Log->addLogCategory({
	...
	'defaultLevel' => 'INFO',
	'description'  => 'SqueezeSonicFran Settings',
});

my $prefs = preferences('plugin.squeezesonicfran');

sub name {
	return Slim::Web::HTTP::CSRF->protectName('PLUGIN_SQUEEZESONICFRAN');
}

sub page {
	return Slim::Web::HTTP::CSRF->protectURI('plugins/SqueezeSonicFran/settings/basic.html');
}
